...
function parseMessage(str) {
  ...
  switch (words[0]) {
    case "I":
      return { LogMessage: { type: 'Info', time: parseInt(words[1]), message: words[2] } }
    case "W":
      return { LogMessage: { type: 'Warning', time: parseInt(words[1]), message: words[2] } }
    case "E":
      return { LogMessage: { type: 'Error', severity: parseInt(words[1]), time: parseInt(words[2]), message: words[3] } }
    default:
      return { Unknown: str }
  }
}
